...
module Narra
  module API
    module Modules
      class LibrariesV1Import < Narra::API::Module
        ...
        resource :libraries do
          ...
          post ':id/import' do
            ...
            return_one_custom(Library, :id, false, [:author]) do |library, roles, public|
              ...
              # load data
              event = Narra::Core.import(library, File.read(params[:file][:tempfile]), current_user._id.to_s)
              # return
